day_four_input = '''una bokpr ftz ryw nau yknf fguaczl anu
...
number_one = "aa bb cc dd ee"
number_two = "aa bb cc dd aa"
number_three = "aa bb cc dd aaa"
trial_list = [number_one, number_two, number_three]

##FIRST STAR
def input_to_phrases(big_list):
	phrase_list = big_list.split('\n')
	return phrase_list

def phrases_to_words(phrases):
	word_list = []
	for i in range(len(phrases)):
		word_list.append(phrases[i].split(" "))
	return word_list

def find_invalid_passphrases(list_of_lists):
